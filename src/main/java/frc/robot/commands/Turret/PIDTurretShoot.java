...
public class PIDTurretShoot extends CommandBase {
  private static final double kP = 0.0013;
  private static final double kI = 0.00000; //0.00002
  ...
  private static final double kD = 0.00000;
  ...
  public PIDTurretShoot(Turret m_robotTurret, double targetSet) {
    target = targetSet;
